...
check("title")
  ...
  .bail()
  .isLength({ min: 5, max: 50 }).withMessage("El titulo debe contener entre 5 y 50 caracteres"),
 ...
 check("price")
  ...
  .bail()
  .isAlphanumeric("es-ES", { ignore: " .," }).withMessage("La descripción debe ser alfanumérico")
  .bail()
  .isLength({ min: 10, max: 100 }).withMessage(
    "El detalle del producto debe tener un mínimo de 10 y un máximo de 300 caracteres"),
